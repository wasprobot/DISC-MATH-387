...
\Ans{The recursive definition of $G$ is used to calculate the values as follows:
    \begin{equation*}
        \begin{aligned}
            \boldsymbol{G(4,0)} &=  G(3,-1)+G(3,0)+G(3,1)       &=5+5+3=\boldsymbol{13}\\
            \\\hline\\
            G(3,-1) &=  G(2,-2)+G(2,-1)+G(2,0)      &=1+2+2=5\\
            G(3,0)  &=  G(2,-1)+G(2,0)+G(2,1)       &=2+2+1=5\\
            G(3,1)  &=  G(2,0)+G(2,1)+G(2,2)        &=2+1+0=3\\
            \\\hline\\
            ...
            G(0,1)  &&= 0\\
            \\\hline\\
            G(2,0)  &=  G(1,-1)+G(1,0)+G(1,1)       &=1+1+0=2\\
            G(1,1)  &=  G(0,0)+G(0,1)+G(0,2)        &=0+0+0=0\\
            \\\hline\\
